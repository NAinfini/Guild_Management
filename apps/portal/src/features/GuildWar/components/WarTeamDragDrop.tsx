...
import { formatClassDisplayName, getClassBaseColor } from '../../../lib/utils';
            ...
            {unassignedMembers.map((m) => (
              <Chip
                ...
                sx={{
                  ...
                  bgcolor: alpha(getClassBaseColor(m.classes?.[0]), 0.12),
                  border: '1px solid',
                  borderColor: alpha(getClassBaseColor(m.classes?.[0]), 0.35),
                }}
              />
            ))}
          </Stack>
                ...
                {team.members.map((m) => (
                  <Box
                    ...
                    sx={{
                      ...
                      border: '1px solid',
                      borderColor: alpha(getClassBaseColor(m.classes?.[0]), 0.35),
                      bgcolor: alpha(getClassBaseColor(m.classes?.[0]), 0.1),
                      borderRadius: 2,
                    }}
                  >
                    <Stack direction="row" spacing={1} alignItems="center">
                      ...
                      <Box>
                        ...
                        <Typography variant="caption" color="text.secondary">{m.classes?.[0] ? formatClassDisplayName(m.classes[0]) : '—'}</Typography>
                      </Box>
                    </Stack>
