...
export function ThemeShowcase() {
  ...
  const [labTheme, setLabTheme] = React.useState<ThemeMode>('neon-spectral');
  ...
  const themes: Array<{ id: ThemeMode; label: string }> = [
    { id: 'neon-spectral', label: t('themes.neon_spectral') },
    { id: 'chinese-ink', label: t('themes.chinese_ink') },
    { id: 'dark-gold', label: t('themes.dark_gold') },
