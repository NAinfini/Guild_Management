...
import { ENDPOINTS, buildPath, type EndpointDef } from '@guild/shared-api/endpoints';
...
export { ENDPOINTS, buildPath } from '@guild/shared-api/endpoints';
export type { EndpointDef, EndpointPath, HttpMethod } from '@guild/shared-api/endpoints';
